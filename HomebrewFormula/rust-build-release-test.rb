...
class RustBuildReleaseTest < Formula
  ...
  on_macos do
    on_arm do
      url 'https://github.com/taiki45/rust-build-release-test/releases/download/v0.1.19/rust-build-release-test-aarch64-apple-darwin.tar.gz'
  ...
  on_linux do
    on_intel do
      url 'https://github.com/taiki45/rust-build-release-test/releases/download/v0.1.19/rust-build-release-test-x86_64-unknown-linux-gnu.tar.gz'
